...
public class Fakes {
    ...
    protected static final Password FakePassword1 = new Password(FakeTitle1, FakeTitle1, FakePasswordString, FakeWebsite, FakeNote1, FakeCreatedAt, FakeIsActive);
    protected static final Password FakePassword2 = new Password(FakeTitle2, FakeTitle2, FakePasswordString, FakeWebsite, FakeNote2, FakeCreatedAt, FakeIsActive);
}
